...
public class FileProviderUtils {
    ...
    public static Uri uriFromFile(Activity activity, File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            String p =  "com.txzh.Function.FileProvider";
    ...
    /**
     * 设置Intent的data和类型，并赋予目标程序临时的URI读写权限 * @param context 上下文 * @param intent 意图 * @param type 类型 * @param file 文件 * @param writeAble 是否赋予可写URI的权限
     */
    ...
    /**
     * 设置Intent的data和类型，并赋予目标程序临时的URI读写权限 * @param context 上下文 * @param intent 意图 * @param type 类型 * @param fileUri 文件uri * @param writeAble 是否赋予可写URI的权限
     */
