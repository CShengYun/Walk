...
public class GroupSearchInfoAdapter extends BaseAdapter  {
    private List<GroupSearchInfoBean> groupSearchInfoBeanList;
    private Context context;
    private ViewHolder viewHolder;
    private Handler handler;

    public GroupSearchInfoAdapter(List<GroupSearchInfoBean> groupSearchInfoBeanList,Context context){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.btn_applyForAdmission.setText("申请加入");
